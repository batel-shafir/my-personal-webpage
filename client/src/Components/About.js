    ...
    <div className="about">
      <div className="about-content">
        ...
        <div>I believe that 
          ...
          which helps me to perform well as a Frontend Developer and basically in 
          everything I do.
        </div> 
        <div> I have excellent
          <span className="color-1"> interpersonal skills </span> &
          <span className="color-1"> high emotional intelligence </span>.
        </div>
